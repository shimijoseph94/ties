<template>
    <div>
        ...
        <div class="container">
            ...
            <h5 style="color:black!important;text-align:left!important;"><strong>Corporate Partnerships</strong></h5>
            <br>
            ...
            <br>
             ...
             <p class="para">•   CSR Projects </p>
             <br>
                <p class="para">•  Carbon Credits </p><br>
                    <p class="para">• Green Campus </p><br>
                        <p class="para">• Pro bono services </p><br>
                            <p class="para">• Employee Engagement </p>
                            <br><br><br>
    <div class="row">
     <div class="col-md-6">
